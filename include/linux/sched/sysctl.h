...
#if defined(CONFIG_ENERGY_MODEL) && ((defined(CONFIG_CPU_FREQ_GOV_SCHEDUTIL) || defined(CONFIG_CPU_FREQ_GOV_SCHEDHORIZON) || defined(CONFIG_CPU_FREQ_GOV_GAME) || defined(CONFIG_CPU_FREQ_GOV_WALT)))
